...
public class Objective_Function {
    public static double[] iPOP_Fit(int item[]) {
        ...
        double requirment_score = 0.0D, score_compliment = 0.0D;
        ...
        if (no_total_requirment != check) {
           ...
           score_compliment = 100 - requirment_score;

        }
        return (new double[]{requirment_score, score_compliment, Pyes, PTmutant,item.length});
    }
}
